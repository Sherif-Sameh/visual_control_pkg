...
def generate_launch_description() -> LaunchDescription:
    ...
    csv_dir = PathJoinSubstitution(
        [FindPackageShare("logging_pkg"), "../../../../logs/csv/hecalib"]
    )
    wandb_dir = PathJoinSubstitution(
        [FindPackageShare("logging_pkg"), "../../../../logs/wandb/hecalib"]
    )
    ...
    config_path = os.path.join(pkg_share, "config", "hecalib_logger.toml")
    config = toml.load(config_path)

    # Initialize nodes to start
    hecalib_logger_node = Node(
        package="logging_pkg",
    ...
    nodes_to_start = [hecalib_logger_node]
