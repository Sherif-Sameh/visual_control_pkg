...
IbvsController::IbvsController() : Node("ibvs_controller")
{
    ...
    m_timer = this->create_wall_timer(0.2s, std::bind(&IbvsController::callback_timer, this));
...
void IbvsController::publish_cam_twist(const vpColVector &v_c)
{
...
void IbvsController::callback_timer()
{
...
{
    if (!m_cam_params.has_value())
    {
        m_cam_params.emplace();
    }
