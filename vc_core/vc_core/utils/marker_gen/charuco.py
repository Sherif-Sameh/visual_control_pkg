...
def main(
    ...
    Args:
        ...
        border: Border bits for generated image.
    ...
    width_px = int(width_m * INCHES_PER_METER * dpi) + 2 * border
    height_px = int(height_m * INCHES_PER_METER * dpi) + 2 * border
    img = board.generateImage((width_px, height_px), 0, border)
